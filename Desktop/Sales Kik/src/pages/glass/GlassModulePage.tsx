...
// Customer interfaces (reused from NewQuotePage)
...
// Customer Search Component (reused from NewQuotePage)
...
export default function GlassModulePage() {
  ...
  useEffect(() => {
    const handleKeyDown = (event: KeyboardEvent) => {
      ...
      if ((event.ctrlKey || event.metaKey) && event.key === '/') {
        ...
        // Add keyboard shortcuts modal if needed
      }
    ...
    <ProtectedGlassComponent>
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="p-6 max-w-none mx-auto">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700">
                    Real-time pricing • 10-step workflow • Customer-specific rates • $35/month module
                  </p>
                </div>
              </div>
          ...
          {/* Customer Selection Header - Matching NewQuotePage */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  {selectedCustomer && (
                    <button className="h-12 px-3 text-blue-600 hover:bg-blue-100 rounded-lg transition-colors flex items-center justify-center"
          ...
          {selectedCustomer ? (
            /* Glass Quoting Interface - Matching NewQuotePage Layout */
            <AdminConnectedGlassQuote 
              quoteId={quoteId}
              customerId={selectedCustomer.id}
              onItemsAdded={() => {
                console.log('Glass item added successfully');
              }}
            />
          ) : (
            /* Customer Selection Prompt - Matching NewQuotePage */
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-lg p-12">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                  <div className="text-center p-6 bg-blue-50 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">Live price updates as you configure glass specifications</p>
                  </div>
                  <div className="text-center p-6 bg-green-50 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">Comprehensive edgework, holes, corners, and finishes</p>
                  </div>
                  <div className="text-center p-6 bg-purple-50 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">Industry-standard quotes and documentation</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-between items-center">
                ...
                <div className="text-center">
                  <p className="text-sm text-gray-500">
                    💡 Tip: Select a customer above to access the full glass quoting interface
                  </p>
                </div>
              </div>
            </div>
