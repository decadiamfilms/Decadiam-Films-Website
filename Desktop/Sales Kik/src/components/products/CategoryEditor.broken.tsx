...
export default function CategoryEditor({ category, onSave, onCancel }: CategoryEditorProps) {
  ...
  const bulkDuplicateSelected = () => {
    ...
    const newSubcategories = selectedSubcategories.map((id, index) => {
      const subcategory = editedCategory.subcategories.find(s => s.id === id);
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-1">
                    ...
                    <button
                      onClick={() => {
                        const duplicatedId = Date.now().toString() + Math.random();
                        ...
                        setTimeout(() => {
                          setEditingSubcategoryId(duplicatedId);
      ...
      <div className="flex items-start justify-center min-h-screen p-4 pt-8">
        <div className="relative bg-white rounded-lg shadow-xl max-w-6xl w-full max-h-[90vh] flex flex-col">
          <div className="flex flex-1 min-h-0">
            ...
            <div className="w-80 border-r border-gray-200 p-6 flex-shrink-0">
              <div className="mb-6">
              ...
              <div className="flex-1 min-h-0 flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto px-6 pb-6">
                  <div
                    onDragOver={handleDragOver}
                    onDrop={handleDrop}
                    className="border-2 border-dashed border-gray-300 rounded-lg p-4 hover:border-green-400 hover:bg-green-50 transition-all duration-200 min-h-96"
                  >
