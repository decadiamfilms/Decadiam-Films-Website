...
import EnhancedOrderModal from './EnhancedOrderModal';
...
function RichTextEditor({ value, onChange, placeholder = "Enter text...", minHeight = "100px", orderItems = [] }: RichTextEditorProps) {
  ...
  const handleAIAction = async (action: string) => {
    ...
    try {
      ...
      switch (action) {
        case 'fix':
          prompt = `Please fix the formatting and grammar of this order description: "${currentText}"`;
          break;
        case 'elaborate':
          prompt = `Please elaborate and expand on this order description: "${currentText}"`;
          break;
        case 'generate':
          ...
          prompt = `Generate a comprehensive, professional order description based on these products: ${productDetails}. Create detailed, business-appropriate content explaining what we're providing.`;
          break;
        case 'simplify':
          prompt = `Please simplify this order description: "${currentText}"`;
          break;
        case 'formalize':
      ...
      if (action === 'generate') {
        ...
        fallbackContent = '<p>We are pleased to present this comprehensive order for your project. Our team has carefully reviewed your requirements and selected high-quality materials to ensure exceptional results.</p>';
      }
        ...
        <div className="fixed top-1/4 right-8 bg-white border-2 border-purple-200 rounded-xl shadow-2xl p-4 z-[70] w-80 max-h-96 overflow-y-auto">
          <div className="space-y-3">
            <div className="border-b border-gray-200 pb-3">
              ...
              <p className="text-sm text-gray-600">Enhance your order description with AI</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <div className="text-sm text-purple-700">Create description based on order items</div>
              </button>
...
interface OrderDetailsModalProps {
  isOpen: boolean;
  onClose: () => void;
  onGenerateOrder: (finalOrderData: FinalOrderData) => void;
  onSaveDraft: () => void;
...
export default function OrderDetailsModal({
  ...
  // Order details from first page - editable
  ...
  // Options (separate from order total) - Grouped by category
  ...
  }, [hasUnsavedChanges, editableJobSections, headerText, standardText, editableProjectName, editableReferenceNumber, orderId]);
  ...
  const duplicateItem = (sectionId: string, itemId: string) => {
    ...
    const duplicatedItem: OrderLineItem = {
      ...item,
  ...
  const handleGenerateOrder = () => {
    ...
    if (errors.length > 0) {
      alert('Please complete the following before generating the order:\n\n• ' + errors.join('\n• '));
      return;
    }
    
    // All validation passed - open the enhanced order modal
    ...
    <div className="fixed inset-0 z-50 bg-white">
          ...
          <div className="flex items-center justify-between relative z-10">
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-gray-700 text-lg font-medium">Fine-tune your order before generation</p>
          ...
          <div className="max-w-full mx-auto px-8 py-8 space-y-8">
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                {/* Order ID - Always second */}
                <div>
                  <label className="block text-base font-medium text-gray-700 mb-2">Order ID</label>
                  <input
                    type="text"
                    value={orderId}
                    disabled
            ...
            {/* Order Header Text Editor */}
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-bold text-gray-900">Order Header Text</h3>
                <button
              ...
              {showHeaderTextEditor && (
                <RichTextEditor
                  ...
                  placeholder="Enter text to appear at the top of your order..."
                  minHeight="150px"
                  orderItems={allItems}
                />
              )}
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-6">Order Settings</h3>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-base font-medium text-gray-700 mb-2">Order Expiry Date</label>
                  <input
                    type="date"
              ...
              <div className="space-y-4">
                ...
                {deliveryMethod === 'pickup' && (
                  <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <p className="text-green-700 text-sm mt-2">
                      This information will be automatically added to the order with your company address details.
                    </p>
                  </div>
                )}
                ...
                {deliveryMethod === 'courier' && (
                  <div className="mt-6 p-4 bg-purple-50 border border-purple-200 rounded-lg">
                    ...
                    />
                    <p className="text-purple-700 text-sm mt-2">These terms will be added to the order for courier delivery</p>
                  </div>
                )}
                ...
                {deliveryMethod === 'to-be-confirmed' && (
                  <div className="mt-6 p-4 bg-orange-50 border border-orange-200 rounded-lg">
                    ...
                    <p className="text-orange-800 text-sm leading-relaxed">
                      The delivery location and method will be confirmed later. This will be clearly stated on the order.
                    </p>
                    <div className="mt-3 p-3 bg-orange-100 border border-orange-300 rounded-lg">
                      <p className="text-orange-900 text-sm font-medium">
                        📋 Order will show: "Delivery location and method to be confirmed prior to dispatch"
                      </p>
                    </div>
                  </div>
                )}
        ...
        <div className="sticky bottom-0 bg-gray-50 border-t border-gray-200 px-6 py-4 rounded-b-xl">
          <div className="flex justify-end gap-4">
            ...
            <button
              ...
              title={!isOrderReady() ? 'Please complete all required fields' : 'Generate Order'}
            >
              Generate Order
            </button>
          </div>
      ...
      <EnhancedOrderModal
        ...
        onClose={() => {
          ...
          navigate('/orders'); // Navigate to All Orders page
        }}
        customer={customer}
