...
interface AdminConnectedGlassOrderProps {
  orderId: string;
  customerId: string;
  onItemsAdded: () => void;
  onAddGlassToOrder?: (glassItem: {
    glassType: any;
    thickness: any;
    quantity: number;
    heightMm: string;
...
export default function AdminConnectedGlassOrder({ 
  orderId, 
  customerId, 
  onItemsAdded,
  onAddGlassToOrder
}: AdminConnectedGlassOrderProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-bold text-gray-900 text-xl">Professional Glass Order Builder</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    <div className="grid grid-cols-2 gap-2">
                      <button
                        onClick={() => {
                          // Replace current order with quick calc settings
                          console.log('Replacing current order with quick calc settings');
                      ...
                      <button
                        onClick={() => {
                          // Create new order with current settings
                          console.log('Creating new order with current settings');
                          setShowQuickCalculator(false);
                        }}
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
          ...
          {adminProcessingOptions.length === 0 ? (
            ...
            <div className="space-y-8">
              ...
              {/* Processing - Other Sections with same structure as quote... */}
              {/* (Truncated for brevity - similar structure for corners, holes, services, surface) */}
      ...
      {/* Professional Order Summary & Finalization */}
      {selectedThickness && heightMm && widthMm && priceBreakdown && (
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
          ...
          <div className="flex items-center justify-between mt-8 pt-6 border-t border-gray-200">
            ...
            <button
              onClick={() => {
                if (onAddGlassToOrder && priceBreakdown) {
                  // Use the proper order integration function
                  onAddGlassToOrder({
            ...
            >
              ...
              Add to Order • ${priceBreakdown?.total.toFixed(2) || '0.00'}
            </button>
          </div>
        </div>
      )}
